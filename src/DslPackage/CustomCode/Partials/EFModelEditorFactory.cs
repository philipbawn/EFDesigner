...
namespace Sawczyn.EFDesigner.EFModel
{
   partial class EFModelEditorFactory
   {
      ...
      {
         editorCaption = $" [{physicalView}]";
         return new EFModelDocView(docData, ServiceProvider, physicalView);
      }
      ...
      {
         EFModelDiagram diagram = viewContext as EFModelDiagram;
         return diagram?.Name ?? "Default";
      }
   }
}
