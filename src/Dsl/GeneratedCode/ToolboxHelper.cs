...
namespace Sawczyn.EFDesigner.EFModel
{
	...
	public abstract class EFModelToolboxHelperBase
	{
		...
		/// item filters.
		/// </remarks>
		public const string ToolboxFilterString = "EFModel.1.3";
		/// <summary>
		/// Toolbox item filter string used to identify ModelClass element tool.
		/// </summary>
		public const string ModelClassFilterString = "ModelClass.1.3";
		/// <summary>
		/// Toolbox item filter string used to identify UnidirectionalAssociation connector tool.
		/// </summary>
		public const string UnidirectionalAssociationFilterString = "UnidirectionalAssociation.1.3";
		/// <summary>
		/// Toolbox item filter string used to identify BidirectionalAssociation connector tool.
		/// </summary>
		public const string BidirectionalAssociationFilterString = "BidirectionalAssociation.1.3";
		/// <summary>
		/// Toolbox item filter string used to identify Generalization connector tool.
		/// </summary>
		public const string GeneralizationFilterString = "Generalization.1.3";
		/// <summary>
		/// Toolbox item filter string used to identify Comment element tool.
		/// </summary>
		public const string CommentFilterString = "Comment.1.3";
		/// <summary>
		/// Toolbox item filter string used to identify CommentsReferenceTypes connector tool.
		/// </summary>
		public const string CommentsReferenceTypesFilterString = "CommentsReferenceTypes.1.3";
		/// <summary>
		/// Toolbox item filter string used to identify Enumeration element tool.
		/// </summary>
		public const string EnumerationFilterString = "Enumeration.1.3";
		...
		public virtual DslDesign::ModelingToolboxItem GetToolboxItem(string itemId, DslModeling::Store store)
		{
			...
			switch(itemId)
			{
				...
				case "Sawczyn.EFDesigner.EFModel.CommentToolboxItem":
					...
					break;
				case "Sawczyn.EFDesigner.EFModel.CommentsReferenceTypesToolboxItem":

					// Add CommentsReferenceTypes connector tool.
					result = new DslDesign::ModelingToolboxItem(
						"Sawczyn.EFDesigner.EFModel.CommentsReferenceTypesToolboxItem", // Unique identifier (non-localized) for the toolbox item.
